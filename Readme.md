...
**Cevap:**
**y=0,27-  orjinden geçmez çünkü sabit terim var**
...
**Cevap**:
**Benim bulduğum değer -644 videoda bulunan değer -640 yani yakın.**
...
6. Grafiği defterinize çiziniz.Sonra size verdiğim google sheet örneğini kullanarak bilgisayar ile grafiği çiziniz. Değerler yakın mı? Google sheet dosyasının bağlantısını ver. [buraya bağlantı ver](https://docs.google.com/spreadsheets/d/1FpQDyJiAWvEPEtLbDPulKOMleXV5XIagqoc-WIsSKe8/edit?usp=sharing)
